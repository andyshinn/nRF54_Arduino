  ...
  switch ( ulMode )
  {
    case INPUT:
      ...
      port->PIN_CNF[ulPin] = ((uint32_t)GPIO_PIN_CNF_DIR_Input        << GPIO_PIN_CNF_DIR_Pos)
                           ...
                           | ((uint32_t)GPIO_PIN_CNF_DRIVE1_S1        << GPIO_PIN_CNF_DRIVE1_Pos)
    ...
    case OUTPUT_H0S1:
      ...
      port->PIN_CNF[ulPin] = ((uint32_t)GPIO_PIN_CNF_DIR_Output       << GPIO_PIN_CNF_DIR_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_INPUT_Disconnect << GPIO_PIN_CNF_INPUT_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_PULL_Disabled    << GPIO_PIN_CNF_PULL_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_DRIVE0_H0        << GPIO_PIN_CNF_DRIVE0_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_DRIVE1_S1        << GPIO_PIN_CNF_DRIVE1_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_SENSE_Disabled   << GPIO_PIN_CNF_SENSE_Pos);
    break;
    ...
    case OUTPUT_S0H1:
      ...
      port->PIN_CNF[ulPin] = ((uint32_t)GPIO_PIN_CNF_DIR_Output       << GPIO_PIN_CNF_DIR_Pos)
                           ...
                           | ((uint32_t)GPIO_PIN_CNF_PULL_Disabled    << GPIO_PIN_CNF_PULL_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_DRIVE0_S0        << GPIO_PIN_CNF_DRIVE0_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_DRIVE1_H1        << GPIO_PIN_CNF_DRIVE1_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_SENSE_Disabled   << GPIO_PIN_CNF_SENSE_Pos);
    break;
    ...
    case OUTPUT_D0S1:
      ...
      port->PIN_CNF[ulPin] = ((uint32_t)GPIO_PIN_CNF_DIR_Output       << GPIO_PIN_CNF_DIR_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_INPUT_Disconnect << GPIO_PIN_CNF_INPUT_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_PULL_Disabled    << GPIO_PIN_CNF_PULL_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_DRIVE0_D0        << GPIO_PIN_CNF_DRIVE0_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_DRIVE1_S1        << GPIO_PIN_CNF_DRIVE1_Pos)
                           | ((uint32_t)GPIO_PIN_CNF_SENSE_Disabled   << GPIO_PIN_CNF_SENSE_Pos);
    break;
