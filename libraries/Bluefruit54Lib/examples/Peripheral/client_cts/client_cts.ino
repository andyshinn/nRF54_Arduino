 ...
 * to Bluefruit54, and then press PAIR.
 * 
...
//  while ( !Serial ) delay(10);   // for nrf52840 with native usb
  ...
  Serial.println("Bluefruit54 BLE Client Current Time Example");
  Serial.println("-------------------------------------------\n");

  Serial.println("Go to iOS's Bluetooth settings and connect to Bluefruit54");
